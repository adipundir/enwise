    ...
    <div className="space-y-10">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-zinc-500">
              ...
              . Uses the <code>mcp-remote</code> bridge so you can use it even on
              builds that don't yet support HTTP transports directly.
            </p>
          </div>
      ...
      <section className="rounded-2xl border border-zinc-900 bg-[#0c0c0c] p-6">
        ...
        <ul className="mt-3 space-y-1.5 text-sm text-zinc-300">
          <li>→ "What does my envoice business profile look like right now?"</li>
          <li>→ "Set up my business: I'm Acme Design, based in Brooklyn, default currency USD."</li>
          <li>→ "Add a client called Globex, email bill@globex.com."</li>
        </ul>
        <p className="mt-4 text-xs text-zinc-500">
          Most of those tools land in Phase 2–3. For now, <code>whoami</code> is
          available.
        </p>
      </section>
    </div>
