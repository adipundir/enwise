  ...
  server.registerTool(
    ...
    async (args, extra) => {
      ...
      const result = await createInvoice(ctx, {
        ...
        acceptedPaymentMethods: d.accepted_payment_methods ?? ["bank"],
